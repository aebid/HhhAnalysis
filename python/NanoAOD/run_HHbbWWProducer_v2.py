...
run2syncfile = {
2016: ["/eos/user/t/tahuang/Sync_2021/sync_2016_m750.root"],
2017: ["/eos/user/t/tahuang/Sync_2021/sync_2017_m750.root"],
2018: ["/eos/user/t/tahuang/Sync_2021/sync_2018_m750.root"]
}
...
p=PostProcessor(outputdir, run2syncfile[Runyear],"1","keep_and_drop.txt", modules, friend = True, jsonInput = None, provenance=True, outtreeName="syncTree")
