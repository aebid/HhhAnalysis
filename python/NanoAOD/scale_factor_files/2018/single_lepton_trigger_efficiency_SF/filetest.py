...
el_file = ROOT.TFile("Electron_Run2018_Ele32orEle35.root")
mu_file = ROOT.TFile("Muon_Run2018_IsoMu24orIsoMu27.root")
...
f_new = ROOT.TFile("ele_and_mu_SF_2018.root", "recreate")
